...
// Get company profile
router.get('/profile', authenticate, authorize('company'), asyncHandler(async (req: AuthRequest, res) => {
  ...
  res.json((companyProfile as any[])[0]);
}));

// Complete company profile
router.post('/complete-profile', authenticate, authorize('company'), asyncHandler(async (req: AuthRequest, res) => {
