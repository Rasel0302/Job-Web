...
export class UploadService {
    static uploadDir = path.join(process.cwd(), 'uploads', 'profiles');
    ...
    static async processAndSaveProfilePhoto(buffer, userId, userType = 'user') {
        try {
    ...
    static async deleteProfilePhoto(photoPath) {
        if (!photoPath)
            return;
        try {
